...
interest_choice = prompt_with_options(all_interests, "Enter your interests (comma-separated): ")
selected_interests = [interest.strip() for interest in interest_choice.split(",")]
